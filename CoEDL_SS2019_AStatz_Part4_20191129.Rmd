...
Unfortunately, we cannot easily compute robust variable importance for RF models nor C or Somersâ€™ D~xy~ which is why it is advisable to create analogous models using both the "cforest" and the "randomForest" functions. In a last step, we can now visualize the results of the optimized RF.
